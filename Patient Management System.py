...
class Database:
    def __init__(self):
        ...
        self.dbCursor.execute(
            "CREATE TABLE IF NOT EXISTS patient_table (id PRIMARYKEY text, firstname text, lastname text, dateOfAdmission text, monthOfAdmission text, yearOfamission text, gender text, address text, contactNumber text, emailAddress text, bloodType text, history text, doctor text)")

    def __del__(self):
        self.dbCursor.close()
        self.dbConnection.close()

    def Insert(self, id, firstname, lastname, dateOfAdmission, monthOfAdmission, yearOfAdmission, gender, address, contactNumber, emailAddress, bloodType, history, doctor):
        self.dbCursor.execute("INSERT INTO patient_table VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (
        id, firstname, lastname, dateOfAdmission, monthOfAdmission, yearOfAdmission, gender, address, contactNumber, emailAddress, bloodType, history, doctor))
        self.dbConnection.commit()

    def Update(self, firstname, lastname, dateOfAdmission, monthOfAdmission, yearOfAdmission, gender, address, contactNumber, emailAddress, bloodType, history, doctor, id):
        self.dbCursor.execute(
            ...
            (firstname, lastname, dateOfAdmission, monthOfAdmission, yearOfAdmission, gender, address, contactNumber, emailAddress, bloodType, history, doctor, id))
        self.dbConnection.commit()
...
class InsertWindow:
    def __init__(self):
        ...
        self.yearType = list(range(1999, 2025))
        ...
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"), text="Date of Admission", width=25).grid(pady=5, column=1, row=4)
        tkinter.Label(self.window,  fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"),text="Month of Admission", width=25).grid(pady=5, column=1, row=5)
        tkinter.Label(self.window,  fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"),text="Year of Admission", width=25).grid(pady=5, column=1, row=6)
        ...
        tkinter.Label(self.window,  fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"),text="Patient's Medical Record ", width=25).grid(pady=5, column=1, row=12)
        ...
        # Combobox widgets
        self.dateOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.dateType, width=25)
        self.monthOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.monthType, width=25)
        self.yearOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.yearType, width=25)
        ...
        self.dateOfAdmissionBox.grid(pady=5, column=3, row=4)
        self.monthOfAdmissionBox.grid(pady=5, column=3, row=5)
        self.yearOfAdmissionBox.grid(pady=5, column=3, row=6)
    ...
    def Insert(self):
        ...
        if (self.test == "SUCCESS"):
            self.database.Insert(self.idEntry.get(), self.firstnameEntry.get(), self.lastnameEntry.get(), self.dateOfAdmissionBox.get(),
                                 self.monthOfAdmissionBox.get(), self.yearOfAdmissionBox.get(), self.genderBox.get(), self.addressEntry.get(),
            ...
            self.valueErrorMessage = "Please enter the values in the field " + self.test
    ...
    def Reset(self):
        ...
        self.dateOfAdmissionBox.set("")
        self.monthOfAdmissionBox.set("")
        self.yearOfAdmissionBox.set("")
        self.genderBox.set("")
...
class UpdateWindow:
    def __init__(self, id):
        ...
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman", 10, "bold"), text="Date of Admission",
                      width=25).grid(pady=5, column=1, row=4)
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman", 10, "bold"),
                      text="Month of Admission", width=25).grid(pady=5, column=1, row=5)
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman", 10, "bold"), text="Year of Admission",
        ...
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman", 10, "bold"),
                      text="Patient's Medical Record ", width=25).grid(pady=5, column=1, row=12)
        tkinter.Label(self.window, fg=fg_color, bg=bg_color, font=("times new roman", 10, "bold"),
        ...
        # Combobox
        self.dateOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.dateType, width=20)
        self.monthOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.monthType, width=20)
        self.yearOfAdmissionBox = tkinter.ttk.Combobox(self.window, values=self.yearType, width=20)
    ...
    def Update(self):
        self.database = Database()
        self.database.Update(self.firstnameEntry.get(), self.lastnameEntry.get(), self.dateOfAdmissionBox.get(), self.monthOfAdmissionBox.get(),
                             self.yearOfAdmissionBox.get(), self.genderBox.get(), self.addressEntry.get(), self.contactNumberEntry.get(),
...
class DatabaseView:
    def __init__(self, data):
        ...
        "id", "firstname", "lastname", "dateOfAdmission", "monthOfAdmission", "yearOfAdmission", "gender", "address", "contactNumber", "emailAddress", "bloodType", "history",
        "doctor")
        ...
        self.databaseView.heading("dateOfAdmission", text="Date of Admission")
        self.databaseView.heading("monthOfAdmission", text="Month of Admission")
        self.databaseView.heading("yearOfAdmission", text="Year of Admission")
        ...
        self.databaseView.column("dateOfAdmission", width=100)
        self.databaseView.column("monthOfAdmission", width=100)
        self.databaseView.column("yearOfAdmission", width=100)
...
class LIFECARE:
    def __init__(self):
        ...
        self.homePageWindow.wm_title("Patient Information  Page")
        bg_color = "blue"
        fg_color = "white"
        lbl_color = 'GREEN'
        tkinter.Label(self.homePageWindow, relief=tkinter.GROOVE, fg=fg_color, bg=bg_color, text="LIFE CARE", font=("times new roman",20,"bold"), width=30).grid(pady=20, column=1, row=1)
    ...
    def Update(self):
        ...
        # Button widgets
        tkinter.Button(self.updateIDWindow, width=200, text="Update", command=self.updateID).grid(pady=10, row=3)
